  ...
  <header>
    ...
    <div @click="toggleMenu" class="menu-icon" id="vince_works-menu">
      <transition name="fade" mode="out-in">
        <img v-if="!menuOpen" key="burger" src="/images/svg/burger.svg" id="burger" />
        <img v-else key="cross" src="/images/svg/cross.svg" id="cross" />
      </transition>
    </div>

    <div @click="toggleMail" id="vince_works-mail">
      <img src="/images/svg/mail.svg" id="mail" />
    </div>

    <div v-if="menuOpen" class="overlay-menu" @click="closeAll">
      <NuxtLink to="/projects">Projects</NuxtLink>
    </div>
    <div v-if="menuOpen" class="overlay-menu overlay-menu--lower" @click="closeAll">
      <NuxtLink to="/about">About</NuxtLink>
    </div>

    <div v-if="mailOpen" class="overlay-menu" @click="closeAll">
      <span>hello@vince.works</span>
    </div>
  </header>
</template>
